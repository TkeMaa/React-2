  ...
  return (
    <div className="footer">
        ...
        <div className="rightSide">
          <Link to="https://www.facebook.com/"><img src={fbLogo} alt="fb" /></Link>
          <Link to="https://www.instagram.com/"><img src={igLogo} alt="ig" /></Link>
          <Link to="https://www.pinterest.com/"><img src={ptLogo} alt="pt" /></Link>
        </div>
      </div>
  )
}
